...
public class ReverseNumberTest {
    ...
    public void testReverseNumber() {
        ...
        when(reverseNumber.reverseNumber(number)).thenReturn(expectedResult);

        // Act
        int actualResult = reverseNumber.reverseNumber(number);
